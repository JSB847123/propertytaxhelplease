...
const faqItems: FAQItem[] = [
  {
    ...
    answer: "**근거:** 지방세법 제112조(재산세 도시지역분)\n\n구 도시계획세가 재산세에 통합되면서 도시지역분으로 규정됨\n\n**1. 과세대상**\n- 국토의 계획 및 이용에 관한 법률 제6조의 규정에 의거 도시지역 안에 있는 토지 또는 건축물\n- 제외대상: 공공시설용지, 개발제한구역내의 지상건축물·골프장·유원지·기타이용시설이 없는 토지\n- 즉, 국토계획법상 도시지역에 있는 부동산\n\n※ 부과지역의 고시: 자치단체조례로 부과지역을 고시\n\n**2. 세율**\n시가표준액의 1,000분의 1.4 (0.14%)\n\n**3. 간편 설명**\n도시지역분은 도시계획구역 안에 있는 부동산에 재산세와 함께 추가로 부과되는 세금입니다.\n\n도시의 도로·상하수도·공원 등 각종 도시계획 사업 비용을 마련하기 위한 것으로, 도시 지역에 사는 집이나 건물 소유자에게 일률적으로 부과됩니다.\n\n(재산세 과세표준에 0.14%의 세율을 적용하여 계산됩니다.)"
  },
  {
